...
const config: Config = {
    ...
    [
      "classic",
      {
        docs: {
          ...
          editUrl:
            "https://github.com/little-ddd/little-ddd.github.io/tree/main/",
        },
        blog: {
  ...
  themeConfig: {
    ...
    footer: {
      ...
      copyright: `Copyright © ${new Date().getFullYear()} Little-DDD, Inc. Built with Docusaurus.`,
    },
    prism: {
